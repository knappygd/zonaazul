...
class NewPlate extends StatefulWidget {
  const NewPlate({Key? key}) : super(key: key);

  @override
  _NewPlateState createState() => _NewPlateState();
}

class _NewPlateState extends State<NewPlate> {
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  child: OutlinedButton(
                    onPressed: () async {
                      final String newPlate = newPlateController.text.trim();
                      await FirebaseFirestore.instance
                          .collection('users')
                          .doc(uid)
                          .update({'plate': newPlate, 'defPlate': newPlate});
